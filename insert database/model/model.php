...
class model
{
    ...
    public function updprofile($table, $fn,$ln,$dob,$gender,$email,$phone,$pass,$sub1,$path,$id)
    {
        $update = "update $table set fn='$fn', ln='$ln', dob='$dob',gender='$gender',email='$email',phone='$phone',pass='$pass',subject='$sub1',photo='$path' where id='$id'";
